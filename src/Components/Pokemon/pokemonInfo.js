...
class CharacterInfo extends Component {
  ...
  async componentDidMount() {
    ...
    const pokemonSpeciesInfo = `https://pokeapi.co/api/v2/pokemon-species/${pokemonIndex}/`;

    //const pokemonEvolution = "http://pokeapi.salestock.net/api/v2/evolution-trigger/1/"

    //Pokemon evolution

    //const res = await Axios.get(pokemonEvolution);
    //const evolution = res.data.pokemon_species
      ...
      <div className="info">
        ...
        {this.state ? (
          <div className="card mb-3 contenedor">
            ...
            <div className="row no-gutters m-0 p-4">
              ...
              <div className="col-md-8">
                <div className="card-body margen p-0">
          ...
          <>
            ...
            />
            <h3 className="m-5 text-center">Cargando Pokemon...</h3>
          </>
        )}
        <Footer />
      </div>
